...
//        }
        ...
        self.menuItem = [
            MenuItem(name: "Все категории", image: "🗂", category: "all"),
        ...
        self.serviceItem = [
            MenuItem(name: "Посольства", image: "🏫", category: "embassy"),
            MenuItem(name: "Рестораны/Кафе", image: "🍲", category: "food"),
            MenuItem(name: "Продукты", image: "🍞", category: "shop"),
            MenuItem(name: "Связь/Электроника", image: "📱", category: "connect"),
            ...
            MenuItem(name: "Красота", image: "💅🏼", category: "beauty"),
            MenuItem(name: "Здоровье", image: "❤️‍🩹", category: "health"),
            MenuItem(name: "Страхование/Финансы", image: "💰", category: "insurance"),
